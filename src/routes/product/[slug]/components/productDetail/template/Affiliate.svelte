<div class="w-full ">
    <div class="w-full space-y-3">
        ...
        <div class="w-full h-28 border grid grid-flow-col overflow-auto">
            <div class="w-[400px] h-full bg-black"></div>
            <div class="w-[400px] h-full bg-red-500"></div>
            <div class="w-[400px] h-full bg-blue-500"></div>
            <div class="w-[400px] h-full bg-green-500"></div>
        </div>
    </div>
</div>


<!-- <div class=" w-[400px] h-24 p-2 flex justify-between gap-2 bg-gray-100 rounded-lg">
    <div class="h-full aspect-square rounded-md bg-white">
    ...
    <div class="w-full h-full grid grid-cols-3 grid-rows-3 bg-white px-2 py-1 rounded-md font-medium">
        <div class="col-span-1 row-span-1 h-full w-full">Product:</div>
        <div class="col-span-2 row-span-1 h-full w-full">Xiaomi 14 pro</div>
        <div class="col-span-1 row-span-1 h-full w-full">Price:</div>
        <div class="col-span-2 row-span-1 h-full w-full">Rp. 10.000.000</div>
        <div class="col-span-1 row-span-1 h-full w-full">Store:</div>
        <div class="col-span-2 row-span-1 h-full w-full">Arkana Cell</div>
    </div>
</div> -->
