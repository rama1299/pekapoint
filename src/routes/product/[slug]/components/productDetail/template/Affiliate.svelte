    ...
    <div class="w-full space-y-3">
        <div class="w-full flex justify-between items-end">
            ...
            <div class="flex justify-center gap-3">
                ...
                <div  class="aspect-square bg-gray-200 rounded-md flex justify-center items-center cursor-pointer" on:click={goToNextPage}>
        ...
        <div class="w-full py-2 px-1 border-gray-100 rounded-lg border-2">
            ...
            >
                ...
                <div class="w-[350px] lg:w-[390px] h-24 p-2 flex justify-between gap-2 bg-gray-100 rounded-lg">
