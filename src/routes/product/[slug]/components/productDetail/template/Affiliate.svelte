    ...
    <div class="w-full space-y-3">
        <div class="w-full flex justify-between items-start">
            ...
            <div class="flex justify-center gap-3">
                <div class="aspect-square bg-gray-100 border rounded-md flex justify-center items-center cursor-pointer hover:bg-gray-200" on:click={goToPrevPage}>
                    <i class='bx bx-chevron-left text-3xl'></i>
                </div>
                <div  class="aspect-square bg-gray-100 border rounded-md flex justify-center items-center cursor-pointer hover:bg-gray-200" on:click={goToNextPage}>
        ...
        <div class="w-full py-2 px-1 border-gray-100 rounded-lg border-2">
            ...
            >
                ...
                <div class="w-[350px] lg:w-[390px] h-28 p-2 flex justify-between gap-2 border-2 border-gray-100 bg-gray-100 rounded-lg hover:border-sky-500 hover:bg-sky-100">
