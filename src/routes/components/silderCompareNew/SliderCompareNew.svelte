...
<div class="w-full flex justify-between items-end px-2">
    <p class="text-2xl font-semibold">Latest Comparison</p>
...
<div class="pt-4 md:pt-0 w-full flex justify-center">
    <div class="h-11 w-52 bg-sky-500 hover:bg-white border-2 border-sky-500 text-white hover:text-sky-500 duration-100 rounded-md flex justify-center items-center cursor-pointer" on:click={() => {goto(`/compare?filter=new`)}}>
