        ...
        <div class="w-full h-full flex justify-center items-center gap-1 relative group">
            {#each dataProduct as product, i}
                <div class="w-1/2 h-full space-y-2">
                    <div class="w-full aspect-auto h-44 md:h-auto md:aspect-square overflow-hidden flex justify-center items-end group-hover:scale-105 duration-200" on:click={() => {goto(`${item.url}`)}}>
