<footer class="divide-y dark:bg-gray-800 dark:text-white-100">
	<div class="lg:w-2/3 w-11/12 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				<span class="self-center text-3xl font-bold">Comparify</span>
			</a>
		</div>
		<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div class="space-y-3">
				<div class="flex uppercase dark:text-gray-50 md:justify-end justify-start">Social media</div>
				<div class="flex md:justify-end justify-start space-x-3">
